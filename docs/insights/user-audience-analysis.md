...
- Buddy 宠物推文（功能已于 2026-04-26 下线，但此推文反映了当时的传播亮点）：*"完成度比 Claude Code 高多了！"*
...
| 轻量级匿名报错 | **已放弃** | 2026-04-26 移除：单人项目 + Vibe Coding 节奏下，错误日志的人工分诊成本远高于价值；后续如需要回归可改走"用户主动一键导出 + 私聊群"低成本路径 |
