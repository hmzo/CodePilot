...
const zh: Record<TranslationKey, string> = {
  ...
  // ── Connection status ───────────────────────────────────────
  // Claude Code 已随 CodePilot 一起打包发版，顶部状态胶囊只反映内置二进制
  // 的运行状况；用户机器上其他渠道安装的 claude 仅做信息展示，不参与运行时解析。
  'connection.bundled': '已内置',
  'connection.bundledTitle': 'Claude Code 已内置在 CodePilot 中',
  'connection.bundledDesc': 'CodePilot 已内置 Claude Code v{version},无需额外安装,也不依赖 Node.js。',
  'connection.bundledActive': '内置版本运行中',
  'connection.unavailable': '不可用',
  'connection.unavailableTitle': '内置 Claude Code 不可用',
  'connection.unavailableDesc': '安装包内的 Claude Code 二进制文件缺失或无法启动,请重新安装 CodePilot 以恢复。',
  'connection.version': '版本:{version}',
  'connection.refresh': '刷新',
  'connection.checking': '检测中',
  'connection.otherInstallsTitle': '在系统中检测到其他 Claude 安装',
  'connection.otherInstallsHint': 'CodePilot 始终使用内置版本,这里只是告知你这台机器上还存在其他副本。',
  'connection.missingGit': '缺少 Git',
  'connection.missingGitTitle': '需要安装 Git for Windows',
  'connection.missingGitDesc': 'Claude Code 在 Windows 上需要 Git for Windows 来执行 shell 工具调用。缺少 Git 时所有工具调用都会以 exit code 1 失败。',
  ...
  // Claude Code 在 Windows 上仍然需要 bash 来执行 shell 工具调用,所以即使
  // Claude 本身已内置,这里依旧保留 Git Bash 的引导流程。
  'install.gitDescription': 'Claude Code 需要 Git for Windows 才能执行 shell 工具调用,请先安装。',
  ...
  'feishu.credentialsDesc': '扫码创建并绑定一个飞书个人机器人，App ID 和 Secret 会自动保存',
  'feishu.appId': 'App ID',
  ...
  // ── QR registration ──
  'feishu.qrRegister': '扫码创建机器人',
  'feishu.qrReregister': '重新扫码注册',
  'feishu.qrRegisterTitle': '扫码注册',
  'feishu.qrRegisterHint': '用飞书 App 扫描下方二维码，并在飞书中确认授权',
  'feishu.qrWaiting': '等待扫码...',
  'feishu.qrScanned': '已扫码，请在飞书 App 中确认',
  'feishu.qrConfirmed': '授权成功，凭据已保存',
  'feishu.qrExpired': '二维码已过期，请重新生成',
  'feishu.qrFailed': '注册失败',
  'feishu.qrAccessDenied': '已在飞书中拒绝授权',
  'feishu.qrStartFailed': '无法启动扫码注册',
  'feishu.qrSwitchedToLark': '已检测到 Lark 账号',
  'feishu.qrConfirmedRestartFailed': '凭据已保存，但桥接重启失败',
  'feishu.qrRefresh': '重新生成二维码',
  'feishu.notConfigured': '尚未配置',
  'feishu.configuredAs': '已配置: {appId}',
  'feishu.manualEntry': '手动输入凭据',
  'feishu.manualEntryDesc': '已有自建飞书应用？在此手动填入 App ID 与 App Secret',
  ...
  'feishu.step1': '点击「扫码创建机器人」按钮',
  'feishu.step2': '使用飞书 App 扫描出现的二维码',
  'feishu.step3': '在飞书 App 中确认授权，App ID 与 Secret 会自动保存',
  'feishu.step4': '点击「测试连接」确认机器人可用',
  'feishu.step5': '（可选）在「访问与行为」中配置允许的用户/群聊',
  'feishu.step6': '在「桥接控制」面板启动飞书桥接',
  ...
  'assistant.summaryLastHeartbeat': '上次心跳',
  ...
  'assistant.takeoverReonboard': '开启新会话（保留文件）',
  ...
  'cliTools.autoDescribeFailed': 'AI 描述生成失败，请检查 ~/.claude 配置',
  ...
  'setup.openSetupCenterDesc': '检查或重新配置 Claude Code 连接和默认项目目录',
  'setup.open': '打开',

  // Setup: Welcome card
  'setup.welcome.title': '欢迎',
  'setup.welcome.description': 'CodePilot 是 Claude Code 的桌面 GUI 客户端。它直接读取你的 ~/.claude 配置，再通过 MCP、Skills 和远程 Bridge 扩展能力，让助理学会你的工作方式。',

  // Setup: Claude Code card
  'setup.claude.title': 'Claude Code CLI',
  'setup.claude.description': 'CodePilot 已内置 Claude Code,无需额外安装。',
  'setup.claude.detected': '内置 Claude Code 已就绪',
  'setup.claude.notFound': '内置 Claude Code 二进制缺失,请重新安装 CodePilot',
  'setup.claude.conflict': '系统中检测到其他 Claude 安装',
  'setup.claude.conflictUsing': 'CodePilot 正在使用内置版本',
  'setup.claude.conflictOther': '另外发现',
  'setup.claude.conflictRemoveHint': '若不再使用,可手动移除(可选):',
  'setup.claude.conflictResolved': '不影响 CodePilot 运行,仅做信息展示。',
